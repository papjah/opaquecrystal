...
EVItemPointerOffsets:
	db HP_UP,        MON_HP_EVS - MON_EVS
	db PROTEIN,     MON_ATK_EVS - MON_EVS
	db IRON,        MON_DEF_EVS - MON_EVS
	db CARBOS,      MON_SPD_EVS - MON_EVS
	db CALCIUM, MON_SPCLATK_EVS - MON_EVS
	db ZINC,    MON_SPCLDEF_EVS - MON_EVS
